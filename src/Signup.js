...
function Signup() { 
    ...
    const buttonOn2 = (e) =>{if (e.target.value.length > 1 ) { setTwoinp(true);}else if (e.target.value.length <= 0 ) {setTwoinp(false);}}
    const buttonOn3 = (e) =>{if (e.target.value.length > 1 ) {setThreeinp(true);}else if (e.target.value.length <= 0 ) {setThreeinp(false); }}
                            ...
                            <div className='right-sec-main-content'>
                                    ...
                                    <div className='right-form'>
                                        <form className='right-form-body' onSubmit={handleSubmit(onSubmit)} >
                                             ...
                                             <input onChange={(e)=>buttonOn1(e)} name='fullname' placeholder='Enter Your Full Name' type='text'  ref={register({required:true})} />
                                             ...
                                             <input onChange={(e)=>buttonOn2(e)}  name='email' placeholder='Enter Email Address' type='email'  ref={register({required:true})}   />
                                             {errors.email && <p className='modal__errors'>
                                                 <svg className="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"></path></svg>
                                                 Email is required
                                             </p>}
                                             <label>Password</label>
                                             <input onChange={(e)=>buttonOn3(e)}  name='password'  placeholder='Enter Password' type='password' ref={register({required:true,
                                                pattern : {
                                                value : /^(?=.*?[a-z])(?=.*?[A-Z])(?=.*?[0-9])(?=.*?[@#$!^%*?&]).{3,}$/ ,
